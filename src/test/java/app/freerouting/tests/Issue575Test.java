...
public class Issue575Test extends TestBasedOnAnIssue
{
  ...
  @Test
  @Disabled("Failing: Board statistics mismatch (Clearance violations 0 vs 7)")
  ...
  @Test
  @Disabled("Failing: Board statistics mismatch (Incomplete 9 vs 0, Clearance 0 vs 4)")
  ...
  @Test
  @Disabled("Failing: Board statistics mismatch (Incomplete 155 vs 7)")
